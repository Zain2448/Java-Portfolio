...
Design and implement a class called Sphere.Sphere that contains instance data that represent a 
sphere’s diameter.
-   Define a Sphere.Sphere constructor to accept and initialize the diameter.
...
-   Create a driver class (main class) called MultiSphere, whose main method instantiates and 
