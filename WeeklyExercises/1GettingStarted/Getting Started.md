...
b. What is the difference between Java SE and Java ME?\
    SE is Standard Edition, used for personal use.
    ME is Micro Edition used to make software running on mobile devices and embedded systems
c. Which operating system is Java available for?\
    It works on many OS as Java is a multiple platform programming language
d. What is the most popular IDE available for Java apart from Eclipse?\
    IntelliJ IDEA
e. What is the main() function for in a Java program?
    Tells the program that this is where the program starts
